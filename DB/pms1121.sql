...
INSERT INTO `m_code` VALUES ('8', '2', '1', '液体', null, null, null, '0', null, null, null, null);
INSERT INTO `m_code` VALUES ('9', '2', '2', '颗粒', null, null, null, '0', null, null, null, null);
INSERT INTO `m_code` VALUES ('10', '2', '3', '粉末', null, null, null, '0', null, null, null, null);
INSERT INTO `m_code` VALUES ('11', '2', '4', '胶质', null, null, null, '0', null, null, null, null);
INSERT INTO `m_code` VALUES ('12', '2', '5', '气体', null, null, null, '0', null, null, null, null);
...
INSERT INTO `m_menu` VALUES ('101', '1', '用户管理', 'PMS.FrmSysUser', 'chk_sys_user', '101', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('102', '1', '角色管理', 'PMS.FrmSysRoleDetail', 'chk_sys_role', '102', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('103', '1', '库房管理', 'PMS.FrmSysFactory', 'chk_sys_factory', '103', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('104', '1', '公司信息', 'PMS.FrmSysCompany', 'chk_sys_company', '104', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('105', '1', '系统设置', 'PMS.FrmSysConfig', 'chk_sys_config', '105', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('201', '2', '商品查询', 'PMS.FrmProductQuery', 'chk_product_query', '201', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('202', '2', '商品管理', 'PMS.FrmProductManage', 'chk_product_set', '202', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('203', '2', '原料管理', 'PMS.FrmMaterialsManage', 'chk_purchase_materials', '203', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('301', '3', '客户管理', 'PMS.FrmCustomerManage', 'chk_sale_customer', '301', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('302', '3', '订单管理', 'PMS.FrmOrderManage', 'chk_sale_order', '302', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('401', '4', '商品入库', 'PMS.FrmProductIn', 'chk_factory_product_in', '401', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('402', '4', '商品出库', 'PMS.FrmProductOut', 'chk_factory_product_o', '402', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('403', '4', '商品调拨', 'PMS.FrmProductTransfer', 'chk_factory_product_transfer', '403', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('404', '4', '原料入库', 'PMS.FrmMaterialsIn ', 'chk_factory_materials_in', '404', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('405', '4', '原来出库', 'PMS.FrmMaterialsOut', 'chk_factory_materials_out', '405', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('501', '5', '生产计划', 'PMS.FrmProducePlan', 'chk_produce_plan', '501', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('601', '6', '供应商管理', 'PMS.FrmProviderManage', 'chk_purchase_provider', '601', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('603', '6', '采购计划', 'PMS.FrmPurchasePlan', 'chk_purchase_plan', '603', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('604', '6', '采购订单', 'PMS.FrmPurchaseOrder', 'chk_purchase_order', '604', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('701', '7', '销售报表', 'PMS.FrmReportSale', 'chk_finance_sale', '701', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('702', '7', '采购报表', 'PMS.FrmReportPurchase', 'chk_finance_purchase', '702', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('703', '7', '应收款', 'PMS.FrmReportReceive', 'chk_finance_receive', '703', '0', null, null, null, null);
INSERT INTO `m_menu` VALUES ('704', '7', '应付款', 'PMS.FrmReportPaid', 'chk_finance_paid', '704', '0', null, null, null, null);
...
CREATE TABLE `p_materials` (
  ...
  `searchIndex` varchar(255) DEFAULT NULL COMMENT '检索索引',
  `packingType` varchar(10) DEFAULT NULL COMMENT '包装方式（Code=001）',
  `packingRemark` varchar(100) DEFAULT NULL COMMENT '包装说明',
  `unitVolume` decimal(10,0) DEFAULT NULL COMMENT '单位体积',
  `unitWeight` decimal(10,0) DEFAULT NULL COMMENT '单位重量',
  `morphology` varchar(100) DEFAULT NULL COMMENT '产品形态（Code=002）',
...
-- ----------------------------
-- Table structure for p_materrials_price
-- ----------------------------
DROP TABLE IF EXISTS `p_materrials_price`;
CREATE TABLE `p_materrials_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `materrialsId` int(11) DEFAULT NULL COMMENT '原料ID',
  `price` decimal(10,0) DEFAULT NULL COMMENT '价格',
  `priceUnit` varchar(10) DEFAULT NULL COMMENT '单位（code=003）',
  `isDelete` int(11) DEFAULT '0',
  `createBy` varchar(50) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `modifyBy` varchar(50) DEFAULT NULL,
...
CREATE TABLE `p_product` (
  ...
  `unitVolume` decimal(10,0) DEFAULT NULL COMMENT '单位体积',
  `unitWeight` decimal(10,0) DEFAULT NULL COMMENT '单位重量',
  `weightUnit` varchar(10) DEFAULT NULL COMMENT '重量单位（Code=003）',
  `morphology` varchar(100) DEFAULT NULL COMMENT '产品形态（Code=002）',
  `shelfLife` int(11) DEFAULT NULL COMMENT '保质期（天）',
  `expiredDays` int(11) DEFAULT NULL COMMENT '过期提醒天数',
  `minStockNum` int(11) DEFAULT NULL COMMENT '最少库存提醒数',
...
-- ----------------------------
-- Table structure for p_product_price
-- ----------------------------
...
INSERT INTO `r_role_menu` VALUES ('37', '2', '2', '1', '1', '2016-11-19 12:18:35', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('38', '2', '202', '1', '1', '2016-11-19 12:18:35', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('39', '2', '201', '1', '1', '2016-11-19 12:18:35', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('40', '2', '302', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('41', '2', '301', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('42', '2', '3', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('43', '2', '2', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('44', '2', '202', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('45', '2', '201', '1', '1', '2016-11-19 12:22:49', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('46', '2', '2', '1', '1', '2016-11-19 12:29:36', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('47', '2', '202', '1', '1', '2016-11-19 12:29:36', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('48', '2', '201', '1', '1', '2016-11-19 12:29:36', '1', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('49', '2', '2', '0', 'admin', '2016-11-21 14:40:13', 'admin', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('50', '2', '0', '0', 'admin', '2016-11-21 14:40:13', 'admin', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('51', '2', '202', '0', 'admin', '2016-11-21 14:40:13', 'admin', '2016-11-21 14:40:13');
INSERT INTO `r_role_menu` VALUES ('52', '2', '201', '0', 'admin', '2016-11-21 14:40:13', 'admin', '2016-11-21 14:40:13');
