...
namespace Dal
{
    public class DalFactory
    {
        ...
        public int AddFactory(ModelFactory _modelFactory)
        {
            ...
            sbSql.Append("       " + _modelFactory.country + ", ");
            sbSql.Append("      " + _modelFactory.province + ", ");
            sbSql.Append("      '" + _modelFactory.provinceName + "', ");
            sbSql.Append("       " + _modelFactory.city + ", ");
            sbSql.Append("      '" + _modelFactory.cityName + "', ");
            sbSql.Append("       " + _modelFactory.district + ", ");
            sbSql.Append("      '" + _modelFactory.districtName + "', ");
        ...
        public int UpdateFactory(ModelFactory _modelFactory)
        {
            ...
            sbSql.Append("    country = " + _modelFactory.country + ",");
            sbSql.Append("    province = " + _modelFactory.province + ",");
            sbSql.Append("    provinceName = '" + _modelFactory.provinceName + "',");
            sbSql.Append("    city = " + _modelFactory.city + ",");
            sbSql.Append("    cityName = '" + _modelFactory.cityName + "',");
            sbSql.Append("    district = " + _modelFactory.district + ",");
            sbSql.Append("    districtName = '" + _modelFactory.districtName + "',");
