    ...
    public partial class FrmProducePlan : Main.BaseForm
    {
        ...
        private void doSubmit()
        {
            ...
            for (int i = 0; i < this.dataGridView1.Rows.Count; i++)
            {
                ...
                if (this.dataGridView1.Rows[i].Cells["selected"].EditedFormattedValue.ToString() == "True")
                {
                    ...
                    dc.Add("specsId", ConvertUtils.ConvertToInt(this.dataGridView1.Rows[i].Cells["specsId"].Value));
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dataGridView1.Columns[e.ColumnIndex].Name == "queryStore")
            {
                ...
                string specsName = ConvertUtils.ConvertToString(this.dataGridView1.Rows[e.RowIndex].Cells["specsName"].Value);

                Form form = new Store.FrmProductQueryStore(factoryId, productName, specsName);
                form.ShowDialog();
            }
        }
