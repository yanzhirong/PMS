...
{
    public partial class FrmSysUserDetail : Main.BaseForm
    {
        //处理模式（0：新建；1：修改；2：删除；9:修改登录者信息）
        private int m_mode;
        //用户ID
        ...
        public FrmSysUserDetail()
        {
            InitializeComponent();


            m_mode = 9;
            m_userId = LoginUserInfo.LoginUser.loginUser.userId; ;
        }
        ...
        {           
            ...
            if (m_mode != 0 && m_userId > 0)
            {
                ...
                //电话
                this.txt_telphone.Text = modelUser.telphone;
        ...
        private void doSubmit()
        {
            ...
            modelUser.telphone = this.txt_telphone.Text;
        ...
        private void txt_pwd2_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = WinCommon.IsOnlyEnNum(e.KeyChar);
