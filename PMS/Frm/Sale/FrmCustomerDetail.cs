...
{
    public partial class FrmCustomerDetail : Main.BaseForm
    {
        //处理模式（0：新建；1：修改；2：删除）
        private int m_mode;
        //原来ID
        ...
        {           
            ...
            {
                this.grb_customer.Enabled = false;
                this.btn_paid.Visible = true;
                this.btn_certificate.Visible = true;
            }
            else
            {
                this.grb_customer.Enabled = true;
                this.btn_paid.Visible = false;
                this.btn_certificate.Visible = false;
            }
        ...
        private void btn_certificate_Click(object sender, EventArgs e)
        {
            ...
            Form form = new FrmCustomerCert(m_customerId, this.txt_name.Text.Trim());
            form.ShowDialog();
