...
{
    public partial class FrmProductQuery : Main.BaseForm
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Columns[e.ColumnIndex].Name == "queryStore")
            {
                ...
                Form form = new Store.FrmProductQueryStore(0, productName, "");
                form.ShowDialog();
                doSelect();
            }

            //查询规格
            if (dataGridView1.Columns[e.ColumnIndex].Name == "querySpecs")
            {
                int id = (int)dataGridView1.Rows[e.RowIndex].Cells["id"].Value;
                Form form = new FrmProductSpecs(3, id);
                form.ShowDialog();
                doSelect();
            }
        }
