...
{
    public partial class FrmPurchaseOrder : Main.BaseForm
    {
        ...
        private void FrmPurchaseOrder_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i < this.cmb_orderStatus.Items.Count; i++)
            {
                ...
                if ((int)item.itemKey == (int)Enum.EnumPurchaseOrderStatus.Purchasing)
                {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Columns[e.ColumnIndex].Name == "confirmBtn")
            {
                ...
                if(orderStatus == (int)Enum.EnumPurchaseOrderStatus.Purchasing)
                {
