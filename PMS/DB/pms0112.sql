...
INSERT INTO `m_sequence` VALUES ('2', 'ProductOutPut', '3');
...
CREATE TABLE `p_product_output` (
  ...
  `delieryDate` datetime DEFAULT NULL COMMENT '交货日期',
  `outputStatus` int(11) DEFAULT NULL COMMENT '状态（0：请求出库；1：已出库）',
...
-- ----------------------------
INSERT INTO `p_product_output` VALUES ('1', '20170103161158_2', '2', '1', '2017-01-07 16:59:23', '0', '0001-01-01 00:00:00', null, null, '0', 'cw1', '2017-01-03 16:11:47', null, null);
INSERT INTO `p_product_output` VALUES ('2', '20170103161242_3', '3', '2', '2017-01-31 16:00:45', '0', '0001-01-01 00:00:00', null, null, '0', 'cw1', '2017-01-03 16:12:42', null, null);
...
INSERT INTO `p_saleorder` VALUES ('5', '20170103160956_7', '1', '4', '0', '', '0', '0', '0', '320000', '江苏省', '320200', '无锡市', '320204', '北塘区', 'test', '', '', '2017-01-31 16:09:24', '1', '', '0', 'xs1', '2017-01-03 16:09:55', 'xs1', '2017-01-03 16:09:55');
INSERT INTO `p_saleorder` VALUES ('6', '20170103161107_8', '1', '4', '0', '', '0', '0', '0', '430000', '湖南省', '430300', '湘潭市', '430381', '湘乡市', 'test', '', '', '2017-01-31 16:10:44', '1', '', '0', 'xs1', '2017-01-03 16:11:07', 'xs1', '2017-01-03 16:11:07');

-- ----------------------------
-- Table structure for p_store
-- ----------------------------
DROP TABLE IF EXISTS `p_store`;
CREATE TABLE `p_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `factoryId` int(11) DEFAULT NULL COMMENT '库房ID',
  `goodsType` int(11) DEFAULT NULL COMMENT '类型（0：商品；1：原料）',
  `saleOrderId` int(11) DEFAULT NULL COMMENT '销售订单ID',
  `purchaeOrderId` int(11) DEFAULT NULL COMMENT '采购订单ID',
...
-- ----------------------------
INSERT INTO `r_product_output_detail` VALUES ('1', '20170103161158_2', '7', '1', '0', '0001-01-01 00:00:00', '0', 'cw1', '2017-01-03 16:11:47', null, null);
INSERT INTO `r_product_output_detail` VALUES ('2', '20170103161242_3', '4', '1', '0', '0001-01-01 00:00:00', '0', 'cw1', '2017-01-03 16:12:42', null, null);
INSERT INTO `r_product_output_detail` VALUES ('3', '20170103161242_3', '7', '2', '0', '0001-01-01 00:00:00', '0', 'cw1', '2017-01-03 16:12:42', null, null);
